  ...
  <section class="row">
    ...
    <section class="col-6 px-5">
      ...
      <div  v-if="productData.product_versions">
        <strong class="block font-bold tw-typography-headline-5 display-5" v-if="versionPrice > 0">${{ numeral(versionPrice).format('0,0.00')}} JMD</strong>
    ...
    <select @change="updateVersionPrice($event)" class="form-control px-5">
      ...
      <strong v-else class="block font-bold tw-typography-headline-5 display-5">${{ numeral(productData.price).format('0,0.00')}} JMD</strong>
